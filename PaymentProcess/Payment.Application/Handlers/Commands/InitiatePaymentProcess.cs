...
{
    public class InitiatePaymentProcess : IRequest<ResponseModel<PaymentDto>>
    {
    ...
    public class InitiatePaymentProcessQueryValidator : AbstractValidator<InitiatePaymentProcess>
    {
        public InitiatePaymentProcessQueryValidator()
        {
    ...
    public class InitiatePaymentProcessQueryHandler : IRequestHandler<InitiatePaymentProcess, ResponseModel<PaymentDto>>
    {
        ...
        public InitiatePaymentProcessQueryHandler(ICheapPaymentGateway dbContext, IExpensivePaymentGateway dbexpensive, PremiumPaymentGateway premiumPaymentGateway)
        {
